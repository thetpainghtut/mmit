       ...
       <div class="row">
           <div class="col-md-12">
               <div class="panel panel-default">
                ...
                <h3>Dashboard </h3> <br>
                    <button @click="initAddCity()" class="btn btn-success " style="padding:5px">
                     Add New City
                     </button>
                   </div>
                   <div class="panel-body table-responsive">
              <table class="table table-bordered table-striped" v-if="cities.length > 0">
                           <tbody>
                           <tr>
                               <th>
                                   No.
               ...
               <div class="modal-content">
                   ...
                   <div class="modal-body">
                       ...
                       <div class="form-group">
                           ...
                           <input type="text" name="name" id="name" placeholder="City Name" class="form-control"
                                  v-model="city.name">
                       </div>
                   </div>
