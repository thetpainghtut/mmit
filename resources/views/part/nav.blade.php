<div id="app">
    ...
    <div id="wrapper">
      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center mt-2 mb-3" href="dashboard">
        ...
        <li class="nav-item">
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="city"> 
                City 
              </a>
              
              <a class="collapse-item" href="township">
                Township
              </a>

              <a class="collapse-item" href="position">
                Position
              </a>
        ...
        <li class="nav-item">
          ...
          <div id="collapseStudent" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="student">
                Student
              </a>
              
              <a class="collapse-item" href="inquire">
                Inquire
              </a>
        ...
        <li class="nav-item">
          ...
          <div id="collapseCourse" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="section">
                Section
              </a>

              <a class="collapse-item" href="duration">
                Duration
              </a>


              <a class="collapse-item" href="teacher">
                Teacher
              </a>
              ...
              <a class="collapse-item" href="location">
                Location
              </a>
            </div>
          </div>
        ...
        <li class="nav-item">
          ...
          <div id="collapseCompany" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="company">
                Company
              </a>

              <a class="collapse-item" href="jobcareer">
                Job Career
              </a>
        ...
        <li class="nav-item">
          ...
          <div id="collapseInterview" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="interview">
                Interview List
              </a>

              <a class="collapse-item" href="hire">
                Hire List
              </a>

              <a class="collapse-item" href="dismiss">
                Dimiss List
              </a>
        ...
        <li class="nav-item">
          ...
          <div id="collapseExpense" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="expense"> 
                Expense 
              </a>
              
              <a class="collapse-item" href="income">
                Income
              </a>
